...
# ATDD-3.6-I14: regression — self-check baselineskip ≈ 18bp (AC-7 — caption formatting must not touch body spacing)
...
run_test "P1" "ATDD-3.6-I14" "regression: self-check baselineskip ~18bp (AC-7 — caption must not touch body spacing)" test_baselineskip_18bp
...
test_total_pages() {
  ...
  echo "  (pages: $total_pages, expected ~51 ±5 [caption formatting in-place])"
