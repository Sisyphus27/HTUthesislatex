...
if [[ "$SKIP" == "1" ]]; then
  ...
  echo "         3.7-03 (\\wuhao 五号 body), 3.7-04 (\\@biblabel [N] list), 3.7-05 (\\list dims declared — value-agnostic)."
  ...
  echo ""
  echo "   NOTE: AC-2 hanging-indent STYLE = DECISION-PENDING (reference reversed vs current standard vs spec"
  echo "         §2.14 '序号左顶格'); 3.7-05 is value-agnostic, the behavior/style verdict = integration I05/I11."
