...
\htuthesis{}（河南师范大学学位论文模板）提供河南师范大学本科毕业设计（论文）和研究生学位
论文的模板，其代码来源于清华大学学位论文模板（\textsc{ThuThesis}），并根据《河南
师范大学材料科学与工程学院本科毕业设计（论文）基本规范》和《河南师范大学学位论文写作规范
...
规定的分隔符，英文关键词同理。该分隔符在 \texttt{htuthesis.def} 中定义。

\end{cabstract}

\ckeywords{TeX/LaTeX, XeLaTeX与中文处理, 科技排版, 河南师范大学, 学位论文
模板, 关于摘要}
...
Academic thesis template, Henan Normal University, About keywords}
