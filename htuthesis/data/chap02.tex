...
下表列出了 \htuthesis{} 的主要文件及其功能介绍。模板核心文件只有两个：\texttt{zzuthesis.cls} 和 \texttt{zzubib.bst}。其中 \texttt{zzuthesis.cls} 文件定义了模版所需要的命令，\texttt{zzubib.bst} 文件则定义了参考文献的风格。由于学校规范中对参考文献风格的规定较为模糊，建议直接采用最新的国家标准《信息与文献参考文献著录规则》(\emph{GB/T 7714-2015}) 中规定的参考文献格式，对该问题的讨论见 https://github.com/tuxify/zzuthesis/issues/2。
