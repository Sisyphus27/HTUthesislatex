...
\htuthesis(\textbf{H}enan  \textbf{T}extile \textbf{U}niversity \textbf{Thesis})以
ctexbook文档类为基础，根据清华大学学位论文模板修改而来。本科毕业设计（论文）
和研究生学位论文（含硕士和博士）分别根据《河南师范大学材料科学与工程学院本科毕业
设计（论文）基本规范》和《河南师范大学学位论文写作规范格式》的规范要求定制，目前
该模板已基本符合相关《规范》的要求。
...
下表列出了 \htuthesis{} 的主要文件及其功能介绍。模板核心文件只有两个：\texttt{htuthesis.cls} 和 \texttt{htuthesis.bst}。其中 \texttt{htuthesis.cls} 文件定义了模版所需要的命令，\texttt{htuthesis.bst} 文件则定义了参考文献的风格。由于学校规范中对参考文献风格的规定较为模糊，建议直接采用最新的国家标准《信息与文献参考文献著录规则》(\emph{GB/T 7714-2015}) 中规定的参考文献格式。
...
\begin{itemize}
\item 浏览器下载：从项目仓库获取发布版本
\item git 命令：\texttt{git clone <repository-url>}
\end{itemize}
